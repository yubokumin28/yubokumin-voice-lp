        ...
        <LiquidGlassCard className="!bg-white/70 p-6 md:p-7">
          <div className="flex flex-col sm:flex-row sm:items-center gap-5">
            <div className="flex-1">
              <div className="eyebrow text-lagoon-600 mb-1">Try it ・ 無料 ・ v1.1.2</div>
            ...
            <div className="flex gap-2 shrink-0">
              <a href="https://github.com/yubokumin28/grow-voice-releases/releases/download/v1.1.2/GrowVoice-Windows-v1.1.2.zip"
              ...
              <a href="https://github.com/yubokumin28/grow-voice-releases/releases/download/v1.1.2/GrowVoice-macOS-v1.1.2.zip"
          ...
          <p className="text-xs text-ink-mute mt-3">
            ...
            共通: AIが覚えた言い換えは実際に使われた回数で確定し、しばらく使われない誤登録は自動で取り消すよう改善しました(v1.1.2)。<br />
